        ...
        <main className="w-full flex">
            <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
                <div className="relative z-10 w-full max-w-md">
                    <img src="https://blog.homer.com.br/wp-content/uploads/2020/03/Logo-OLX-500x265.png" width={150} />
                    <div className=" mt-16 space-y-3">
                        <h3 className="text-white text-3xl font-bold">Comece a expandir seu negócio rapidamente</h3>
                        <p className="text-gray-300">
                            Crie uma conta e tenha acesso a todos os recursos por 30 dias, sem necessidade de cartão de crédito.
                        </p>
            ...
            <div className="flex-1 flex items-center justify-center h-screen">
                <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                    ...
                    <div className="relative">
                        ...
                        <p className="inline-block w-fit text-sm bg-white px-2 absolute -top-2 inset-x-0 mx-auto">Ou continue com</p>
                    </div>
                    <form
